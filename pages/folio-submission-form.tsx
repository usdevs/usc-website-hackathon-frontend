...
export default function FolioSubmissionForm() {
  return (
    ...
    <Heading size='md' mt={4}>Create New Entry</Heading>
        ...
        label='Module Code' 
        optionName='Module' 
        options={['NSW2001', 'NSW2002', 'NSW2003']} />  {/*TODO: Pull from Backend here*/}

        <SelectCard
        label='Instructor' 
        optionName='Instructor'
        options={["Dr Alberto Perez Pereiro",
                    "Dr Bjorn Gomez",
                    "Dr Chanad Somaiah",
                    "Dr Cheng Yi En",
                    "Dr Hanisah Sani",
                    "Dr Lee Chee Keng"]} />  {/*TODO: Pull from Backend here*/}

        <SelectCard
        label='Academic Year'
        optionName='Academic Year'
        options={['2018', '2019', '2020', '2021', '2022', '2023']} /> {/*TODO: Pull from Backend here*/}

        <SelectCard
        label='Semester'
        optionName='Semester'
        options={['Semester 1', 'Semester 2', 'Special Term 1', 'Special Term 2']} /> {/*TODO: Pull from Backend here*/}
