...
const IGDetails: IGInfo[] = [
    {
        ...
        description: 'The Asian Undergraduate Summit (AUS) is a student-led, student-run international conference by' +
            ...
            <HStack divider={<StackDivider borderColor='gray.200'/>}>
                ...
                <Box pt={'1vh'}>
                    <SimpleGrid columns={[1, null, 2]} maxWidth={'1000px'} spacing='40px'>
                        {IGDetails.map(IGDetail => <IGCard key={IGDetail.title} ig_info={IGDetail}/>)}
                    </SimpleGrid>
                </Box>
            </HStack>
            <Footer/>
