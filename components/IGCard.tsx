import {Box, Button, Card, Center, CardBody, CardFooter, Heading, Image, Stack, Text, VStack} from "@chakra-ui/react";
            ...
            <CardFooter>
                <VStack>
                    <Button
                        ...
                        leftIcon={<FaUserCircle/>} variant='outline' colorScheme='blue' minWidth={'8vw'} maxWidth={'8vw'}>
                        <Text noOfLines={[1]}>
